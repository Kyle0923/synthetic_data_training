...
def main():
    ...
    train_loader_16_0 = load_training_data(
        original_data_path, synthetic_data_path, num_original, num_synthetic
    )

    num_original = 16
    num_synthetic = 2
    train_loader_16_8 = load_training_data(
        original_data_path, synthetic_data_path, num_original, num_synthetic
    )

    num_original = 12
    num_synthetic = 4
    train_loader_16_16 = load_training_data(
        original_data_path, synthetic_data_path, num_original, num_synthetic
    )

    num_original = 4
    num_synthetic = 12
    train_loader_16_32 = load_training_data(
        original_data_path, synthetic_data_path, num_original, num_synthetic
    )
    ...
    model_descriptions = [
        "16 real images, 0 synthetic images",
        "16 real images, 8 synthetic images",
        "16 real images, 16 synthetic images",
        "16 real images, 32 synthetic images",
    ]
